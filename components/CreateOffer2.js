            ...
            <View style={styles.container}>
              <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
                ...
                <TextInput style={styles.input1}  onChangeText={text => 
                  setProductName(text)} value={productName} textContentType=''> 
                  </TextInput>
                </View>
                ...
                <View >
                      ...
                      <TextInput style={styles.input1} onChangeText={text => 
                                setContacts(text)} value={contacts} />
                </View>
                ...
                <TextInput style={styles.input2} multiline={true} onChangeText={text => 
                    setDescription(text)} value={description} />
                </View>
